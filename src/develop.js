...
import develop from "./picture/developer.png";
          ...
          <div className="row col-sm-12 mt-4 all-content">
            ...
            <div className="col-sm-10 d-flex flex-wrap">
              <div className="col-sm-6">
                <div className="card">
                  <div className="card-header">Pengembang</div>
                  <div className="card-body">
                    <div className="mb-3 d-flex flex-row">
                      <img src={develop} alt="" className="mr-3" />
                      <table>
                        <tbody>
                          <tr>
                            <th scope="row">Nama</th>
                            <td>:</td>
                            <td>Nyoman Gede Sentana Putra</td>
                          </tr>
                          <tr>
                            <th scope="row">Asal</th>
                            <td>:</td>
                            <td>Banjar Tainsiat, Denpasar</td>
                          </tr>
                          <tr>
                            <th scope="row">Alamat</th>
                            <td>:</td>
                            <td>Jalan Nangka Selatan, Gang. 2 No. 7</td>
                          </tr>
                          <tr>
              ...
              <div className="col-sm-6">
                <div className="card">
                  <div className="card-header">Kontraktor</div>
                  <div className="card-body">
                    <div className="mb-3 d-flex flex-row">
                      <img
                        src="picture/developer.png"
              ...
              <div className="col-sm-12 mt-4">
                <div className="card">
                  <div className="card-header">Dokumen</div>
                  <div className="card-body">
                    <div style={{ fontSize: "18px", color: "#e94342" }}>
                      <div className="d-flex flex-row align-items-center">
                        <img src="picture/document.svg" alt="" />
                        <p className="mt-3 ml-2">
                          Nota Kesepakatan (MoU) Pembuatan Monumen Sita
                          Kepandung.pdf
                        </p>
                      </div>
                      <div className="d-flex flex-row">
                        <img src="picture/document.svg" alt="" />
                        <p className="mt-3 ml-2">
                          Konsep Monumen Sita Kepandung.pdf
                        </p>
                      </div>
                      <div className="d-flex flex-row">
                        <img src="picture/document.svg" alt="" />
                        <p className="mt-3 ml-2">
                          Nyoman Gede Sentana Putra.pdf
                        </p>
                      </div>
                      <div className="d-flex flex-row">
                        <img src="picture/document.svg" alt="" />
